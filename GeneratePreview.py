...
class Preview:
	def Generate(pdf_exportFile):
		...
		p1.text((textPosX,int((8.0-4.6-0.4)*height/8.0)),pdf_exportFile.company,fill=black,font=arialBold8)
		p1.text((textPosX,int((8.0-4.1-0.4)*height/8.0)),pdf_exportFile.postal_city,fill=black,font=arial6)
		p1.text((textPosX,int((8.0-3.7-0.4)*height/8.0)),pdf_exportFile.street,fill=black,font=arial6)
		p1.text((textPosX,int((8.0-3.3-0.4)*height/8.0)),pdf_exportFile.stationary,fill=black,font=arial6)
		p1.text((textPosX,int((8.0-2.9-0.4)*height/8.0)),pdf_exportFile.mobile,fill=black,font=arial6)
		p1.text((textPosX,int((8.0-2.5-0.4)*height/8.0)),pdf_exportFile.mail,fill=black,font=arial6)
